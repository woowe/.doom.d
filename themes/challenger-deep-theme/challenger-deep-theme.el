...
(let ((ct '((class color) (min-colors 89)))
  ...
  (let* ((bg              "#000")
    ...
    (custom-theme-set-faces
     ...
     `(font-lock-keyword-face           ((,c (:foreground ,keywords :bold ,bold))
                                         (,ct (:foreground ,ct-keywords))))
     `(font-lock-string-face            ((,c (:foreground ,strings))
                                         (,ct (:foreground ,ct-strings))))
     `(font-lock-type-face              ((,c (:foreground ,type :bold ,bold))
     ...
     `(rainbow-delimiters-depth-3-face   ((,c (:bold ,bold :foreground ,green-d))
